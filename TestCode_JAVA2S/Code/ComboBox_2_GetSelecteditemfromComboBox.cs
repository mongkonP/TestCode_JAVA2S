//http://www.java2s.com/Code/CSharp/GUI-Windows-Form/GetSelecteditemfromComboBox.htm
...
{ 
   public   class ComboBox_2_GetSelecteditemfromComboBox:Form
    {
        private Button draw = new Button();
        private ComboBox color = new ComboBox();

        public   ComboBox_2_GetSelecteditemfromComboBox()
       {
